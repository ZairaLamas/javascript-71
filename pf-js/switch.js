...
*/
let country = prompt(`Elige un país de los 5 países permanentes de la ONU:
    1. Estados Unidos
    2. China
    3. Francia
    4. Reino Unido
...
switch (country) {
    case "Estados Unidos":
        alert(`La capital de ${country} es Washington`);
        break;
    case "China":
        alert(`La capital de ${country} es Pekin`);
        break;
    case "Francia":
        alert(`La capital de ${country} es París`);
        break;
    case "Reino Unido":
        alert(`La capital de ${country} es Londres`);
        break;
    case "Rusia":
        alert(`La capital de ${country} es Moscú`);
        break;
    default:
        alert("El país seleccionado no es miembro permanente")
}